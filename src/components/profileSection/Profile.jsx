              ...
              <div className="card1">
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-2 text-center d-flex justify-content-center align-items-center">
                          <p className="text-muted mb-0">
                            MAC Shadescent Lipstick Candy Yum-Yum
                          </p>
                        </div>
                        <div className="col-md-2 text-center d-flex justify-content-center align-items-center">
                      ...
                      <div className="row">
                        <div className="col-md-2">
                          <img
                            src={two}
                            className="img-fluid"
                            alt="Lipstick Contrary"
                          />
                        </div>
                        <div className="col-md-2 text-center d-flex justify-content-center align-items-center">
                          <p className="text-muted mb-0">
                            Yves Saint Laurent Rouge Pur Couture The Slim Matte
                            Lipstick Contrary Fuchsia
                          </p>
                        </div>
                        <div className="col-md-2 text-center d-flex justify-content-center align-items-center">
                ...
                >
                  <h5 className="d-flex align-items-center justify-content-center text-white text-uppercase mb-0">
                    <span className="h2 mb-0 ms-2">Total paid : $1040</span>
                  </h5>
                </div>
              </div>
            </div>
